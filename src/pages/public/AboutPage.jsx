...
const AboutPage = () => {
  return (
    <div className="bg-base-100">
      {/* Hero Section */}
      <div className="bg-primary/5 py-20 sm:py-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-lg text-neutral/80 max-w-3xl mx-auto">
            Eld Clean was born from a simple idea: to make premium, effective, and safe cleaning products accessible to every household and business in Kenya.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
            ...
            <div className="order-1 lg:order-2">
              <img 
                src="https://placehold.co/600x450/0D9488/FFFFFF?text=Our+Workspace" 
                alt="Eld Clean Workspace" 
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              <div className="bg-white p-8 rounded-lg shadow-md border border-base-200">
